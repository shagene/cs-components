    ...
    <Container maxWidth="lg">
      ...
      >
        <Grid item md={6} pr={{ xs: 0, md: 3 }}>
          <LabelWrapper color="success">{t('Version') + ' 1.0'}</LabelWrapper>
          <TypographyH1
            sx={{
              mb: 2
            }}
          ...
          >
            ...
            {t(`Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime mollitia,
